...
```{r read-in-data}
cells <- read.csv(file = "~/home//Segmentation/BCexh_RNAscope/cpout/cell.csv", stringsAsFactors = FALSE)

image <- read.csv(file = "~/home/Segmentation/BCexh_RNAscope/cpout/Image.csv", stringsAsFactors = FALSE)

relationships <- read.csv(file = "~/home/Segmentation/BCexh_RNAscope/cpout/Object relationships.csv", 
                            stringsAsFactors = FALSE)

panel <- read.csv(file = "~/home/Segmentation/BCexh_RNAscope/panel_for_R.csv", stringsAsFactors = FALSE)
```
...
```{r clean-meta}
meta <- read.csv("~/home/workflowr/BCexh_IMC/data/ROI_info_RNAscope_TLSrevised.csv")
```
...
tags <- read.csv("~/home//Segmentation/BCexh_RNAscope/tiffs/20200811_ST_BCexh_R_TBB075_s0_p3_r1_a1_ac_full.csv", header = FALSE)
...
In our case, the SampleId and ROI uniquely define an image for the RNA-panel:
...
col_vec_sampleIds <- c("#00B6EB", "#E38900", "#FB61D7", "#06A4FF", "#C49A00", "#53B400", "#99A800", "#DF70F8", "#00BC56", "#00C094", "#00BFC4", "#A58AFF")
...
```{r save-RDS}
saveRDS(sce, "~/home/workflowr/BCexh_IMC/output/sce_RNApanel_initial_TLSrevised.rds")
```
