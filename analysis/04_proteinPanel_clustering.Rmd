...
sce_protein <- readRDS(paste0(getwd(), "/output/sce_ProteinPanel_afterQC.rds"))
```
...
saveRDS(sce_protein_sub, paste0(getwd(), "/output/RNApanel/sce_proteinpanel_sub_UMAP.rds"))
```
...
# Save 
saveRDS(sce_tumor, paste0(getwd(), "/output/ProteinPanel/sce_ProteinPanel_tumor.rds"))
saveRDS(sce_stroma, paste0(getwd(), "/output/ProteinPanel/sce_ProteinPanel_stroma.rds"))

# Save updated objects
saveRDS(sce_protein, paste0(getwd(), "/output/ProteinPanel/sce_ProteinPanel_TS_assigned.rds"))
saveRDS(sce_protein_sub, paste0(getwd(), "/output/ProteinPanel/sce_ProteinPanel_sub_UMAP.rds"))
```
