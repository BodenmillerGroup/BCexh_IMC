...
for (i in unique(cur_sce$ImageNumber)){
  ...
  # get T cell IDs
  cellIDs_PD1 <- cur_sce_i[cur_sce_i[,"subtype"] == "CD4_PD1",]
  PD1_shortID <- paste0(cellIDs_PD1$ImageNumber, "_", cellIDs_PD1$CellNumber)
  cellIDs_nonPD1 <- cur_sce_i[cur_sce_i[,"subtype"] %in% c("CD4"),]
  nonPD1_shortID <- paste0(cellIDs_nonPD1$ImageNumber, "_", cellIDs_nonPD1$CellNumber)
...
aDC_nr <- table(cur_sce$ImageNumber, cur_sce$celltype)[,"aDC"]
aDC_img <- names(aDC_nr[aDC_nr > 15])
PD1_nr <- table(cur_sce$ImageNumber, cur_sce$subtype)[,"CD4_PD1"]+table(cur_sce$ImageNumber, cur_sce$subtype)[,"CD8_PD1"]
