...
# sce_myeloid$subtype <- ifelse(sce_myeloid$marker_ratio >= 1, "myeloid_CD68-high", "myeloid_CD11c-high")
# 
...
dittoPlot(sce_protein, "CD11c", group.by = "subtype", plots = "vlnplot", assay = "scaled", vlnplot.width = 1.5)
...
## Check cell type preference for TLS
...
ggplot(cvs[order(cvs$mean_cv),], aes(reorder(celltype, mean_cv), y = mean_cv)) +
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1), axis.title.x = element_blank(),
        panel.background = element_blank())+
  ggtitle("Mean CV of cell type proportions (across ROIs of the same sample)")
