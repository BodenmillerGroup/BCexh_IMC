...
```{r visualize-features-umap, message = FALSE, fig.width=10, fig.height=10}
...
```{r cluster-mean-expression-heatmap, message=FALSE, fig.width=10, fig.height=10}
...
## Plot
#Raw
dittoHeatmap(clustermean_sce_RNA[markers_include_phenograph,], assay = "counts", scale = "none",
...
```{r cluster-umap, fig.width=10, fig.height=8}
